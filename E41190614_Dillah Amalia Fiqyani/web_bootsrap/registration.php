...
<div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 front-weight-bold text-primary">registration</h6>
...
<div class="form-group">
    <input type="text" class="form-control form-control-user" id="user" name="user" placeholder="Username Anda" required>
</div>
<div class="form-group">
...
if ($essay) {
    echo "<strong>Essay:</strong> {$essay} <br>";
}
?>
</form>
</div>
