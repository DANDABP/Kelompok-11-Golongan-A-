...
<head>
    ...
    <title>Dashboard Admin Sinar Abadi</title>
...
<<<<<<< Updated upstream:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/registration.php
                            <button type="submit" class="btn btn-danger" name="submit"> Tambah </button>
=======
                            <div class="card-group">
                                <input type="password" class="form-control form-control-user" id="password" name="confirm" placeholder="confirm" require>
                            </div></br>
                            <button type="submit" class="btn btn-success" name="submit"> Tambah </button>
>>>>>>> Stashed changes:registration.php
