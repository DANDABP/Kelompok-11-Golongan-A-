  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-beetween mb-4">
          ...
          <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown-arrow">
                        <a href="#" class="dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-gaspopup="true"
                        aria-expanded="false">
              ...
              <div class="card-body">
                  <form>
                      ...
                      <div class="card-group">
                          <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Usernmae Anda" required>
                      </div></br>
                      <div class="card-group">
                      ...
                      <textarea class="form-control form-control-user" name="biografi" id="biografi" cols="120" rows="5"></textarea></br>
