<<<<<<< HEAD:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/halaman2.html
<!DOCTYPE html>
<html lang="en">
      ...
      <!-- Produk -->
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/stopkontak.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Uticon Stop Kontak (Arde)</a>
                </h4>
                <h5>Rp 90.000</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/stopkontakt.jfif" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Stop Kontak Kaki Cabang 3</a>
                </h4>
                <h5>Rp 20.000</h5>
                <font color="green">STOK TERSEDIA</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/komporlistrik.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Maspion Kompor Listrik</a>
                </h4>
                <h5>Rp 170.000</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/setrika.jfif" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Miyoko Setrika</a>
                </h4>
                <h5>Rp 99.000</h5>
                <font color="green">STOK TERSEDIA</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/setrika2.jfif" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Philips Setrika</a>
                </h4>
                <h5>Rp 299.00</h5>
                <font color="red">STOK HABIS</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/remotetv.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Remote TV LG LED</a>
                </h4>
                <h5>Rp 15.500</h5>
                <font color="red">STOK HABIS</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/mixer.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Stand Mixer Electrolux</a>
                </h4>
                <h5>Rp 9.000.000</h5>
                <font color="red">STOK HABIS</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/mixer2.jfif" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Miyako Hand Mixer</a>
                </h4>
                <h5>Rp 245.000</h5>
                <font color="green">STOK TERSEDIA</font>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/blender.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Sharp Blender</a>
                </h4>
                <h5>Rp 425.000</h5>
                <font color="green">STOK TERSEDIA</font>
              </div>
        ...
        <div class="center">
          <ul class="pagination">
            ...
            <li><a class="active" href="halaman2.html">2</a></li>
            <li><a href="halaman3.html">3</a></li>
            <li><a href="halaman3.html">»</a></li>
          </ul>
        </div>
...
>>>>>>> f8da14cc60f963aff74fca66e08458f99efa8b90:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/halaman2.php
</html>