        ...
        <div class="container">
            ...
            ?>
                            ...
                            <div class="card h-100">
                                <a href="deskripsi.php?id_barang=<?php echo $data['id_barang']; ?>"><img
                                        class="card-img-top" src="#" alt=""></a>

                                <a href="deskripsi.php?id_barang=<?php echo $data['id_barang']; ?>"><img
                                        class="card-img-top"
                                        src="image_view.php?id_barang=<?php echo $data['id_barang']; ?>" alt=""></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a
                                            href="deskripsi.php?id_barang=<?php echo $data['id_barang']; ?>"><?php echo $data['nama']; ?></a>
                                    </h4>
