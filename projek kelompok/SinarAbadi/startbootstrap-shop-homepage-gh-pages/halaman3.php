<<<<<<< HEAD:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/halaman3.html
<!DOCTYPE html>
<html lang="en">
      ...
      <!-- Produk -->
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/blender2.jfif" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Philips Blender</a>
                </h4>
                <h5>Rp 740.000</h5>
        ...
        <div class="center">
          <ul class="pagination">
            ...
            <li><a class="active" href="halaman3.html">3</a></li>
            <li><a href="#">»</a></li>
          </ul>
        </div>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!-- Produk -->
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <?php
              $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE id_barang = 19");
        ...
        <div class="center">
          <ul class="pagination">
            ...
            <li><a class="active" href="halaman3.php">3</a></li>
            <li><a href="#">»</a></li>
          </ul>
        </div>
...
>>>>>>> f8da14cc60f963aff74fca66e08458f99efa8b90:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/halaman3.php
</html>