...
<div class="card mt-4" style="width: 500px; text-align: left;" >
    ...
    <div class="card-body">
    <img class="card-img-top img-fluid" style="width: 300px" src="img/kirim.jpeg" alt="">
    <h1>Barang anda sedang dikirim tunggu beberapa saat...</h1></center>
    </div>
    <div class="card-footer">
    <div class="col-md-12 text-right"><a href="kirim-selesai.php" class="btn btn-outline-dark btn-danger">barang diterima</a>
    </div>
    </div>
    </div>
    </center>
