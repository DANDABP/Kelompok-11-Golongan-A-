<<<<<<< HEAD:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/kabel.html
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="row">
      ...
      <!-- Produk -->
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/LAN.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/kabel ties.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Kabel Ties</a>
                </h4>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/kabel lampu.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
...
>>>>>>> f8da14cc60f963aff74fca66e08458f99efa8b90:projek kelompok/SinarAbadi/startbootstrap-shop-homepage-gh-pages/kabel.php
</html>